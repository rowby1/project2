...
<link rel="stylesheet" href="/css/prj2_1.css">
...
<script>
  window.onload = function() {
	...
	form.addEventListener('submit', function(e) {
		...
		case "btnList":   // view로 이동
			e.preventDefault(); // submit 취소
			e.stopPropagation();
			
			location.href = "/mboard?cmd=VIEW&id=${boardVo.id}" ;
			break;
		}
 ...
 <%@ include file="/include/chat.jsp" %>
   ...
   <main>
	...
	<table id='upcomment'>
	 ...
	 <tr>
	   <td>내용</td>
	   <td><textarea name="ctext">${ commentVo.ctext }</textarea></td>
	 </tr>
	 <tr>
	   <td colspan="2">
