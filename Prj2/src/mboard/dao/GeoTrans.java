...
public class GeoTrans {
	...
	public static GeoVo convert(int srctype, int dsttype, GeoVo in_pt) {
		GeoVo tmpPt = new GeoVo();
		GeoVo out_pt = new GeoVo();
	...
	public static void geo2tm(int dsttype, GeoVo in_pt, GeoVo out_pt) {
		double x, y;
	...
	public static void tm2geo(int srctype, GeoVo in_pt, GeoVo out_pt) {
		GeoVo tmpPt = new GeoVo(in_pt.getX(), in_pt.getY());
		int max_iter = 6;
	...
	public static double getDistancebyGeo(GeoVo pt1, GeoVo pt2) {
	...
	public static double getDistancebyKatec(GeoVo pt1, GeoVo pt2) {
	...
	public static double getDistancebyTm(GeoVo pt1, GeoVo pt2) {
	...
	*/
	...
	private static void transform(int srctype, int dsttype, GeoVo point) {
		if (srctype == dsttype)
			return;
	...
	private static boolean geodetic_to_geocentric (int type, GeoVo p) {
	 ...
	 */
	private static void geocentric_to_geodetic (int type, GeoVo p) {
   ...
   //  defn = coordinate system definition,
	...
	private static void geocentric_to_wgs84(GeoVo p) {
	...
	private static void geocentric_from_wgs84(GeoVo p) {
